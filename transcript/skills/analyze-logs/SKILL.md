...
1. Read the `stats` output above. That covers tool counts, token totals, top files, top bash, redundant reads, etc. Do **not** re-derive any of those numbers with fresh jq pipelines.
